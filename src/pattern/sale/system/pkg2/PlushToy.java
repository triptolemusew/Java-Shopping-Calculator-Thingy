...
public class PlushToy implements OptionalItems, Patterns{
    ...
    public PlushToy(double price, String description, double material){
        this.price = price;
    ...
    public String printDetails(int mul) {
        if (yesno){
            ...
            r += "Plastic Eye is added. Price will increased to 5%\n";
            return r;
        }else{
            String r = "";
            r += "Item Name: " + this.description + "\n";
