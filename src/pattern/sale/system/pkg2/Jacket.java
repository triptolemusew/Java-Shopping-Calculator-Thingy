...
public class Jacket implements OptionalItems, Patterns  {
    ...
    public Jacket(double price, String description, double material){
        this.price = price;
    ...
    public String printDetails(int mul) {
        if (yesno){
            ...
            r += "Lining is added. Price will increased to 5%\n";
            return r;
        }else{
            String r = "";
            r += "Item Name: " + this.description + "\n";
